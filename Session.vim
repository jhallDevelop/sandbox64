...
set helplang=en
set runtimepath=~/.vim,~/.vim/pack/vendor/start/nerdtree,~/.vim/bundle/Vundle.vim,~/.vim/bundle/vim-fugitive,~/.vim/bundle/nerdtree,~/.vim/bundle/YouCompleteMe,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim91,/usr/local/share/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/vim-fugitive/after,~/.vim/bundle/nerdtree/after,~/.vim/bundle/YouCompleteMe/after
...
exe 'vert 4resize ' . ((&columns * 68 + 102) / 204)
argglobal
setlocal keymap=
setlocal noarabic
...
keepjumps 1
normal! 0
lcd ~/Projects/AF/sandbox64
wincmd w
argglobal
if bufexists(fnamemodify("~/Projects/AF/sandbox64/src/Game.c", ":p")) | buffer ~/Projects/AF/sandbox64/src/Game.c | else | edit ~/Projects/AF/sandbox64/src/Game.c | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
terminal ++curwin ++cols=68 ++rows=28 
let s:term_buf_14 = bufnr()
balt ~/Projects/AF/sandbox64/run64.sh
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
terminal ++curwin ++cols=68 ++rows=29 
